...
- 快速指纹模板补齐热门国家和地区画像，逻辑处理器候选收敛为常见的 8 / 12 / 16 / 24 / 32。
- 代理定位备用地区和精确 IANA 时区解析覆盖同步完善。

## 1.9.0 - 2026-09-22

- 浏览器实例新增远程调试开关，默认关闭；需要 Cookie、标签页控制、自动化或实时指纹自测时可在实例配置中开启。
- 修复实例配置、默认书签和用户数据目录迁移相关问题。
